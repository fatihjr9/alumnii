                    ...
                    <tbody>
                        @foreach($alumnis as $item)
                            <tr class="bg-gray-100 border-b border-gray-300">
                                ...
                                <td class="px-6 py-4">
                                    <button data-modal-target="modal-{{ $item->id }}" data-modal-toggle="modal-{{ $item->id }}" class="underline" type="button">
                                        Lihat Detail
                                    </button>
                                    <div id="modal-{{ $item->id }}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 inset-x-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
