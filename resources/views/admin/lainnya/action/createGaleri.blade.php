    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
            <div class="w-full md:w-96 bg-white p-4 shadow-md rounded-md mx-auto">
                <h5 class="text-lg font-bold border-b pb-2">Tambah Galeri</h5>
                <form action="{{ route('lainnya.tambah-galeri.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col space-y-4 mt-4">
                    @csrf
                    <div>
