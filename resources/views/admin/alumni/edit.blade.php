    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
            <div class="w-full bg-white p-4 shadow-md rounded-md mx-auto">
                <form action="{{ route('alumni.store', $alumni->id) }}" method="POST" class="grid grid-cols-1" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="flex flex-col space-y-4 mb-6 border-b pb-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            <div class="flex flex-col justify-between">
                                ...
                                <input name="foto" value="{{ $alumni->foto }}" type="file" accept="image/*" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full" required>
                            </div>
                            <div class="flex flex-col justify-between">
                                <label class="block mb-2 text-sm font-medium text-gray-900">Nama Alumni</label>
                                <textarea rows="1" placeholder="{{ $alumni->nama }}" name="nama" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"></textarea>
                            </div>
                            <div class="flex flex-col justify-between">
                                <label class="block mb-2 text-sm font-medium text-gray-900">Alamat Alumni</label>
                                <textarea rows="1" placeholder="{{ $alumni->alamat }}" name="alamat" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"></textarea>
                            </div>
                            <div class="flex flex-col justify-between">
                                <label class="block mb-2 text-sm font-medium text-gray-900">Telepon/HP</label>
                                <textarea rows="1" placeholder="{{ $alumni->kontak }}" name="kontak" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"></textarea>
                            </div>
                            <div class="flex flex-col justify-between">
                                <label class="block mb-2 text-sm font-medium text-gray-900">Email</label>
                                <textarea rows="1" placeholder="{{ $alumni->email }}" name="email" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"></textarea>
                            </div>
                            <div class="flex flex-col justify-between">
                                <label class="block mb-2 text-sm font-medium text-gray-900">NPM Alumni</label>
                                <textarea rows="1" placeholder="{{ $alumni->npm }}" name="npm" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"></textarea>
                            </div>
                            <div class="flex flex-col justify-between">
                            ...
                            <div class="flex flex-col justify-between">
                                ...
                                <input name="thn_lulus" placeholder="{{ $alumni->thn_lulus }}" type="date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col space-y-4 mb-6 border-b pb-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            <div class="flex flex-col justify-between">
                                ...
                                <textarea rows="1" placeholder="{{ $alumni->tempat_kerja }}" name="tempat_kerja" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"></textarea>
                            </div>
                            <div class="flex flex-col justify-between">
                                <label class="block mb-2 text-sm font-medium text-gray-900">Alamat Tempat Kerja Sekarang</label>
                                <textarea rows="1" name="alamat_kerja" placeholder="{{ $alumni->alamat_kerja }}" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"></textarea>
                            </div>
                            <div class="flex flex-col justify-between">
                                <label class="block mb-2 text-sm font-medium text-gray-900">Nomor Telepon Tempat Kerja Sekarang</label>
                                <textarea rows="1" name="kontak_kerja" placeholder="{{ $alumni->kontak_kerja }}" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"></textarea>
                            </div>
                            <div class="flex flex-col justify-between">
                                ...
                                <select name="sesuai_minat" value="{{ $alumni->sesuai_minat }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            ...
                            <div class="flex flex-col justify-between">
                                ...
                                <select name="info_kerja" value="{{ $alumni->info_kerja }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            ...
                            <div class="flex flex-col justify-between">
                                ...
                                <select name="waktu_kerja" value="{{ $alumni->waktu_kerja }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            ...
                            <div class="flex flex-col justify-between">
                                ...
                                <select name="alasan" value="{{ $alumni->alasan }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            ...
                            <div class="flex flex-col justify-between">
                                ...
                                <select name="penghasilan_pertama" value="{{ $alumni->penghasilan_pertama }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            ...
                            <div class="flex flex-col justify-between">
                                ...
                                <select name="penghasilan_rata" value="{{ $alumni->penghasilan_rata }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            ...
                            <div class="flex flex-col justify-between">
                                ...
                                <textarea rows="1" placeholder="{{ $alumni->riwayat_kerja }}" name="riwayat_kerja" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"></textarea>
                            </div>
                            <div class="flex flex-col justify-between">
                                ...
                                <textarea rows="1" placeholder="{{ $alumni->nama_alamat_lembaga }}"  name="nama_alamat_lembaga" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"></textarea>
                            </div>
                            <div class="flex flex-col justify-between">
                                <label class="block mb-2 text-sm font-medium text-gray-900">Bentuk lembaga pendidikan tempat saudara bekerja</label>
                                <select name="kategori_lembaga" value="{{ $alumni->kategori_lembaga }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            ...
                            <div class="flex flex-col justify-between">
                                ...
                                <select name="status" value="{{ $alumni->status }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            ...
                            <div class="flex flex-col justify-between">
                                ...
                                <textarea rows="1" placeholder="{{ $alumni->pangkat }}" name="pangkat" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"></textarea>
                            </div>
                            <div class="flex flex-col justify-between">
                                <label class="block mb-2 text-sm font-medium text-gray-900">Jabatan pekerjaan saat ini ( opsional )</label>
                                <textarea rows="1" placeholder="{{ $alumni->jabaran }}" name="jabaran" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col space-y-4 mb-6 border-b pb-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            <div class="flex flex-col justify-between">
                                ...
                                <textarea rows="1" placeholder="{{ $alumni->saran_prodi }}" name="saran_prodi" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"></textarea>
                            </div>
                            <div class="flex flex-col justify-between">
                                ...
                                <textarea rows="1" placeholder="{{ $alumni->saran_himal }}" name="saran_himal" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"></textarea>
                            </div>
                            <div class="flex flex-col justify-between">
                                ...
                                <textarea rows="1" placeholder="{{ $alumni->saran_dosen }}" name="saran_dosen" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"></textarea>
                            </div>
                            <div class="flex flex-col justify-between">
                                ...
                                <select name="interaksi_pimpinan" value="{{ $alumni->interaksi_pimpinan }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            ...
                            <div class="flex flex-col justify-between">
                                ...
                                <select name="layanan_kemahasiswaan" value="{{ $alumni->layanan_kemahasiswaan }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            ...
                            <div class="flex flex-col justify-between">
                                ...
                                <textarea rows="1" name="info_teman" placeholder="{{ $alumni->info_teman }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required></textarea>
                            </div>
                            <div class="flex flex-col justify-between">
                                ...
                                <select name="kesiapan_saudara" value="{{ $alumni->kesiapan_saudara }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            ...
                            <div class="flex flex-col justify-between">
                                ...
                                <select name="jejaring" value="{{ $alumni->jejaring }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            ...
                            <div class="flex flex-col justify-between">
                                ...
                                <textarea name="penyedia_fasilitas" placeholder="{{ $alumni->penyedia_fasilitas }}" rows="1" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"></textarea>
                            </div>
                            <div class="flex flex-col justify-between">
                                <label class="block mb-2 text-sm font-medium text-gray-900">Berikan catatan khusus untuk pengembangan program studi</label>
                                <textarea name="catatan_prodi" placeholder="{{ $alumni->catatan_prodi }}" rows="1" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"></textarea>
                            </div>
                        </div>
                    </div>
