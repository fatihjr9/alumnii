    ...
    <x-slot name="header">
        <div class="flex flex-row items-center justify-between">
            ...
            <div class="flex flex-row items-center gap-x-2">
                ...
                <a href="{{ route('alumni.create') }}" class="px-4 py-2 bg-gray-300 text-black flex flex-row gap-x-1 rounded-md w-fit ml-auto items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-3 h-3">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m6-6H6" />
                    </svg>                      
                    <span class="text-sm">Tambah Alumni</span>                    
                </a>
            </div>
        </div>
    </x-slot>
                    ...
                    <div class="bg-white rounded-md">
                        ...
                        <div class="p-2 flex flex-col space-y-2">
                            ...
                            <div class="flex flex-row items-center justify-between gap-x-1">
                                ...
                                {{-- Dropdown --}}
                                <button id="dropdownHoverButton-{{ $item->id }}" data-dropdown-toggle="dropdownHover-{{ $item->id }}" data-dropdown-trigger="hover" class="w-9 h-9 bg-slate-200 rounded-md" type="button">
                                    ...
                                    <ul class="py-2 text-sm" aria-labelledby="dropdownHoverButton-{{ $item->id }}">
                                        ...
                                        <li>
                                            <form action="{{ route('alumni.destroy', $item->id) }}" method="post" class="px-4 py-2 hover:bg-gray-100">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" onclick="return confirm('Apakah anda yakin menghapus {{ $item->nama }}?')">Delete</button>
                                            </form>
                                        </li>
                                    </ul>
                                </div>
